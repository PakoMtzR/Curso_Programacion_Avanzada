...
---------------------------------------------------------------
Problema: Resolver el problema de que se impriman los N números
 de la Serie de Padovan , donde N es un número entero positivo 
 que el usuario debe ingresar para obtener los valores de la 
 serie, utilizando el paradigma de Programación Funcional 
 (no debe utilizarse ningún otro paradigma)
